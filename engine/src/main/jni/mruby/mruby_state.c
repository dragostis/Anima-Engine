...
Java_org_anima_engine_scripting_MRubyState_getStatePointer(JNIEnv *env, jobject instance) {
    jenv = env;
    this = instance;
...
Java_org_anima_engine_scripting_MRubyState_loadClassToState(JNIEnv *env, jobject instance,
                                                            jlong pointer, jstring javaName,
                                                            jstring rubyName) {
    mrb_state* mrb = (mrb_state*) pointer;
...
JNIEXPORT void JNICALL
Java_org_anima_engine_scripting_MRubyState_loadClassMethodsToState(JNIEnv *env, jobject instance,
                                                                   jlong pointer,
                                                                   jstring className,
                                                                   jstring rubyClassName,
                                                                   jobjectArray javaNames,
                                                                   jobjectArray rubyNames,
                                                                   jobjectArray javaSignatures,
                                                                   jbooleanArray isStatic) {
    mrb_state* mrb = (mrb_state*) pointer;
    ...
    (*env)->ReleaseBooleanArrayElements(env, isStatic, isStaticArray, 0);
}

JNIEXPORT void JNICALL
Java_org_anima_engine_scripting_MRubyState_loadString(JNIEnv *env, jobject instance, jlong pointer,
                                                      jstring mrubyString, jstring fileName) {
    this = instance;
    mrb_state* mrb = (mrb_state*) pointer;
...
JNIEXPORT void JNICALL
Java_org_anima_engine_scripting_MRubyState_close__J(JNIEnv *env, jobject instance, jlong pointer) {
    mrb_state* mrb = (mrb_state*) pointer;
